...
extern const int BRIGHTNESS_PIN; // Pin zur Ansteuerung der Helligkeit
extern const int BRIGHTNESS_CHANNEL; // PWM Kanal zur Ansteuerung der Helligkeit
extern const int BRIGHTNESS_CHANNEL_FREQUENCY;  // PWM Frequenz zur Ansteuerung der Helligkeit
